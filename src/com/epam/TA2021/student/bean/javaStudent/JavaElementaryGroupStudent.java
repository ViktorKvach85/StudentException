...
import com.epam.TA2021.student.group.javagroup.JavaElementaryGroup;

public class JavaElementaryGroupStudent extends JavaElementaryGroup implements Student {
    String name;
    ...
    public JavaElementaryGroupStudent(String name, double ratingFacultySubject, double ratingGroupSubject) {
        this.name = name;
