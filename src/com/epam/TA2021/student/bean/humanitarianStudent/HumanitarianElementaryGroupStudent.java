...
import com.epam.TA2021.student.group.humanitriangroup.HumanitarianElementaryGroup;

public class HumanitarianElementaryGroupStudent extends HumanitarianElementaryGroup  implements Student {
    String name;
    ...
    public HumanitarianElementaryGroupStudent(String name, double ratingFacultySubject, double ratingGroupSubject) {
        this.name = name;
